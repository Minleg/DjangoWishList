...
class TestVisitedPage(TestCase):
    ...
    def test_visited_page_shows_empty_visited_list_for_empty_database(self):
        visted_page_url = reverse('place_visited')
        response = self.client.get(visted_page_url)
...
class VisitedList(TestCase):
    ...
    def test_visited_list_shows_visited_places(self):
        ...
        self.assertNotContains(response, 'Toykyo')
